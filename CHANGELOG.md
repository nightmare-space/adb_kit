...
在全力对标甲壳虫的时候，我发现甲壳虫体验上的确有不少问题

所以 ADB KIT 新的目标是 Scene，我此生敬佩的软件或项目并不多
Shizuku、Scrcpy、Scene
...
照常，我的软件，都至少支持 Mac、Windows、Linux、Android 四个平台，如果后续反馈较好，将来你也可以使用 iOS 版的 ADB KIT，亦或者是网页版的 ADB KIT，完全一致的1软件体验，不用单独为某个平台而学习使用不同的软件

客户端完全开源，部分插件闭源，仓库地址 https://github.com/nightmare-space/adb_kit 
...
- 文件下载: 现在你可以通过 ADB KIT 下载连接设备的文件了
- 文件预览: 视频/图片可以直接打开，视频还支持外挂字幕，极速缓冲
...
谈谈我为什么有的不想开源了，真的就是与钱无关，在当前的网络环境下，很多时候开源你带不来任何会为你仓库做共享的朋友，只是为他们遇到问题只知道发泄的人，提供了一个通道，ADB KIT、Code FA、Fast Share 这几个开源皆都如此

## 1.5.7-beta.3 (2024.09.09)
