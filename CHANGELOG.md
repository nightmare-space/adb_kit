...
在全力对标甲壳虫的时候，我发现甲壳虫体验上的确有不少问题，所以 ADB KIT 新的目标是 Scene

ADB KIT 新的目标是 Scene，我此生敬佩的软件或项目并不多
...
照常，我的软件，都至少支持 Mac、Windows、Linux、Android 四个平台，如果后续反馈较好，将来你也可以使用 iOS 版的 ADB KIT，亦或者是网页版的 ADB KIT，完全一直软件体验，不用单独为某个平台而学习使用不同的软件
