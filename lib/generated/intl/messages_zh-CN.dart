...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "connectMethodDes1" : MessageLookupByLibrary.simpleMessage("1.设备与PC处于于一个局域网"),
    "connectMethodDes2" : MessageLookupByLibrary.simpleMessage("2.打开PC的终端模拟器，执行连接"),
    "connectMethodDes3" : MessageLookupByLibrary.simpleMessage("3.执行adb devices查看设备列表是有新增"),
    "connectMethodTip" : MessageLookupByLibrary.simpleMessage("该功能需要ROOT！！！并且是给本机打开的！！！给对方设备打开无线调试在主页点击已经连接的设备后面的箭头进到的二级页"),
    "currentVersion" : MessageLookupByLibrary.simpleMessage("当前版本"),
    "dark" : MessageLookupByLibrary.simpleMessage("暗黑模式"),
    "debugPaintLayerBordersEnabled" : MessageLookupByLibrary.simpleMessage("显示层级边界"),
    "debugPaintPointersEnabled" : MessageLookupByLibrary.simpleMessage("突出点击对象"),
    "debugPaintSizeEnabled" : MessageLookupByLibrary.simpleMessage("显示文字基准线"),
    "debugRepaintRainbowEnabled" : MessageLookupByLibrary.simpleMessage("显示刷新区域"),
    ...
    "fixDeviceWithoutDataLocalPermission" : MessageLookupByLibrary.simpleMessage("适配部分设备没有 \n/data/local/tmp 的权限问题"),
    "historyConnect" : MessageLookupByLibrary.simpleMessage("历史连接"),
    "home" : MessageLookupByLibrary.simpleMessage("主页"),
    "inputDeviceAddress" : MessageLookupByLibrary.simpleMessage("输入对方设备IP连接"),
    "inputFormat" : MessageLookupByLibrary.simpleMessage("输入格式为“IP地址:端口号 配对码”"),
    "installDes1" : MessageLookupByLibrary.simpleMessage("建议选择 /system/xbin ,因为安卓自带程序大部分都在 system/bin ,装在前者更方便管理个人安装的一些可执行程序。"),
    ...
    "scanQRCodeDes" : MessageLookupByLibrary.simpleMessage("点击可放大二维码，只有同一局域网下对应的二维码才能正常扫描\n二维码支持adb工具、无界投屏、以及任意浏览器扫描\n也支持浏览器直接打开二维码对应IP进行连接"),
    ...
    "showPerformanceOverlay" : MessageLookupByLibrary.simpleMessage("打开性能监控"),
