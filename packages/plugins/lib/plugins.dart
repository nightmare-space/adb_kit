...
import 'package:android_tool/android_tool.dart' as at;
...
void registerADBPlugin() {
  Future.delayed(const Duration(milliseconds: 1000), () {
    PluginManager.instance
      ...
      ..registerADBPlugin(at.AppStarterPlugin())
      ..registerADBPlugin(at.AppManagerPlugin())
      ..registerADBPlugin(at.DeviceInfoPlugin())
      ..registerADBPlugin(at.ProcessPlugin())
      ..registerADBPlugin(at.TaskManagerPlugin());
  });
}
